...
# — tab9's content (defined far below, under "with tab9:") is the PK Rooms
# view, and this lets it render right after Zone CO2 & Temperature without
# having to relocate that whole block of code. Streamlit only cares about
# the position of each variable in this tuple/list, not what it's named.
